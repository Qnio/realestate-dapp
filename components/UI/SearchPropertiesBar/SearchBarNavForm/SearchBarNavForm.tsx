...
const SearchBarNavForm: React.FC<{ onSearchProperties: (searchQuery: SearchProperty) => void, locations: string[] }> =
    (props) => {
            ...
            <NavFormContainer>
                ...
                <FormContainer>
                    ...
                    <FormElement searchButton>
                        <CustomButton searchBtn type='button' onClick={searchFormHandler} width={"4rem"}>
...
export default SearchBarNavForm;
